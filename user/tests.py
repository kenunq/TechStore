...
class Test_User(TestCase):
    ...
    def test_profile_user(self):
        ...
        response = self.client.get('/auth/users/me/', headers={'Authorization': f'JWT {token}'})
        self.assertEquals(response.status_code, 200)
        user_data = {
            'username': self.user1_username,
            'name': self.user1_name,
    ...
    def test_refresh_user(self):
        ...
        response = self.client.post('/auth/jwt/refresh/', data={'refresh': response.data['refresh']}, headers={'Authorization': f'JWT {token}'})
        self.assertEquals(response.status_code, 200)
        self.assertIn('access', response.data)
    ...
    def test_reset_password(self):
        ...
        response = self.client.post('/auth/users/reset_password/', data={'email': self.user1_email})
    ...
    def test_reset_username(self):
        ...
        response = self.client.post('/auth/users/reset_username/', data={'email': self.user1_email})
        self.assertEquals(response.status_code, 204)
    ...
    def test_set_username(self):
        ...
        response = self.client.post('/auth/users/set_username/', data={
